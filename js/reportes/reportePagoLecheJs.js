...
function CargarTablaPrincipal(){
  ...
  window.open("http://asoprolesa-saucetico/view/facturas/imprimirPDFReportePagoLeche.php?lista="+localStorage.getItem("listaTodo")+"&tipo=Pago leche", "popupId", "location=center,menubar=no,titlebar=no,resizable=no,toolbar=no, menubar=no,width=1000,height=600");
