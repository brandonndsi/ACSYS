...
function imprimirTodo(){
  ...
  window.open("http://asoprolesa-saucetico/view/facturas/inprimirTodoDistribuidor.php?lista="+localStorage.getItem("listaTodo")+"&tipo=Distribuidor", "popupId", "location=center,menubar=no,titlebar=no,resizable=no,toolbar=no, menubar=no,width=1000,height=600");
