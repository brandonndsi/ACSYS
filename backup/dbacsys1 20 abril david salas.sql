...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 21, 2018 at 03:51 AM
...
(13, '$2y$10$w1KNZyrTRnUDtstoKb1OOOGjKix4OvSwDK75OlO65Xfsbxmf97s8u', 'Administrador', NULL, NULL, 'activo');
...
--
-- Dumping data for table `tbpagoprestamo`
--
...
(5, 18, '2018-04-18', 'Mañana', 60, 'activo'),
(5, 19, '2018-04-18', 'Tarde', 60, 'activo');
...
--
-- Dumping data for table `tbprestamos`
--
...
--
-- Dumping data for table `tbprestamosporcobrar`
--
...
--
ALTER TABLE `tbahorrosemanal`
  MODIFY `idahorro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `tbcompramateriaprima`
  MODIFY `idcompramateriaprima` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
