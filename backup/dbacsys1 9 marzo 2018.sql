...
--
-- Servidor: localhost
-- Tiempo de generación: 10-03-2018 a las 03:34:23
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `retornarMontoAhorroCliente` (`id` INT)  BEGIN
...
(1, 50, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'activo'),
(4, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'inactivo'),
(5, 40, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'activo'),
