...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-02-2018 a las 05:45:19
...
INSERT INTO tbproductorcliente(idpersonacliente,estadoproductorcliente) VALUES ((SELECT idpersona FROM tbpersona order by idpersona desc limit 1), "activo");
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `registrarproductorsocio` ()  NO SQL
INSERT INTO tbproductorsocio(idpersonasocio,estadoproductorsocio) VALUES ((SELECT idpersona FROM tbpersona order by idpersona DESC limit 1), "activo")$$
...
(1, '$2y$10$.3UMbB.8JcjdTBv53.mVm.IggYtf.GiWAJ2iyIqrgtq03cB1.6X0K', 'Cajero', NULL, NULL, 'activo'),
(12, '$2y$10$JI.5gfdXExhcSMhd2U0oRuigYlBCUJQYlZzIZOaump7X4C4fVAB3.', 'Bodega', NULL, NULL, 'activo'),
(13, '$2y$10$A3qXBNR1NuIM/4sAg0lkie/WhHBP1jWGixZiZssXj9sWv4GdJWvZq', 'Administrador', NULL, NULL, 'activo'),
(20, '$2y$10$GrD76bLbEOav2LI6hbyiUewzPZhDfOP7DnJ9U.7h6gGUpBiV8BkBG', 'Administrador', NULL, NULL, 'activo');
...
(12, '33440667', 'Berny', 'Garro', 'Duran', '66666666', 'la victoria', 'N/A'),
(13, '207210905', 'Brandon', 'Rodriguez', 'Mendez', '62091232', 'Marsella', 'brandon-ndsi@hotmail.com'),
(20, '207650897', 'Lucas', 'Rodriguez', 'N/A', 'N/A', 'San Jose', 'N/A');
...
(7, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'activo'),
(8, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'activo');
...
(4, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'inactivo'),
(5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'activo'),
(6, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'activo'),
(9, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'activo');
...
(8, '10002', 'Agua Florida', 'Para dolor de nuca', '2 cc', 2, 1, 1, 2000, 'activo');
...
--
ALTER TABLE `tbpesalechediario`
  MODIFY `idpesalechediario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
