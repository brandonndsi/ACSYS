...
SELECT tbempleado.passwordempleado, tbpersona.nombrepersona, tbpersona.apellido1persona FROM tbempleado INNER JOIN tbpersona ON tbempleado.idpersonaempleado=tbpersona.idpersona WHERE tbpersona.documentoidentidadpersona=documentoidentidad AND tbempleado.estadoempleado="activo"$$
