                        ...
                        <form method="post">
                            <div style="width:50%; float:left;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <p><input type="text" class="form-control" class="span12" name="documentoidentidadm" id="documentoidentidadm" placeholder="Cédula" 
                                                  onchange="verificarQueSeanQuinceDijitosm(this.id);
                                                          validarEspaciosEnBlancoInput(event, this.id);"
                                                  required maxlength="15"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <p><input type="text"  class="form-control" class="span12" name="nombrem"  id="nombrem" placeholder="Nombre"
                                                  onkeypress="return textonly(event);" 
                                                  onchange="validarEspaciosEnBlancoInput(event, this.id);verifyOnChange(this.id);"
                                                  data-toggle="tooltip" data-placement="top" title="Nombre" placeholder="Nombre" required/></p>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <p><input type="text" class="form-control" class="span12" name="primerapellidom" id="primerapellidom" placeholder="1° Apellido" 
                                                  onkeypress="return textonly(event);" 
                                                  onchange="validarEspaciosEnBlancoInput(event, this.id);verifyOnChange(this.id);"
                                                  data-toggle="tooltip" data-placement="top" title="Primer Apellido" placeholder="Primer Apellido" required/></p>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <p><input type="email" class="form-control" class="span12" name="correom" id="correom" placeholder="Email"  pattern="^[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$"onchange="verificarCorreo(this);"/></p>
                                    </div>
                                </div>
                            </div>
                            <div style="width:50%; float:left;">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <p><input type="text" class="form-control" class="span12" name="telefonom" id="telefonom" placeholder="Teléfono"  
                                                  onkeypress="return soloNumeros(event);"  onchange="verifyOnChange(this.id);
                                                          validarEspaciosEnBlancoInput(event, this.id);
                                                          verificarQueSeanOchoDijitos(this.id);" data-toggle="tooltip" data-placement="top" title="Tel&eacute;fono, debe incluir 8 d&iacute;gitos" placeholder="Tel&eacute;fono" required maxlength="8"  /></p>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <p><input type="text" class="form-control" class="span12" name="direccionm" id="direccionm"  placeholder="Dirección"  
